...
private:
	...
	void buildSegmentTree(int startOfRange, int endOfRange, int indexOfSegmentTree, vector<int>&v) {
		...
		segmentTreeArray[indexOfSegmentTree] = segmentTreeArray[indexOfSegmentTree*2 + 1] + segmentTreeArray[indexOfSegmentTree*2 + 2];   // Change here
	}
	...
	int query(int startOfRange, int endOfRange, int indexOfSegmentTree, int l, int r) {
		...
		return leftSide + rightSide;  // Change here
